...
python infer.py --config_path ./configs/WavTokenizer_small_600_24k_4096.yaml \
...
python infer.py --config_path ./result/train/wavtokenizer_smalldata_frame40_3s_nq1_code4096_dim512_kmeans200_attn_train860/lightning_logs/version_0/config.yaml \
    --model_path ./result/train/wavtokenizer_smalldata_frame40_3s_nq1_code4096_dim512_kmeans200_attn_train860/lightning_logs/version_0/checkpoints/last-v1.ckpt \
    --ll WavTokenizer_small_320_24k_4096_repl
    """
# --coding:utf-8--
import os
...
parser.add_argument('--ll', type=str, default="WavTokenizer_small_600_24k_4096", help='Subfolder name for output')
